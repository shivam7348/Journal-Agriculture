...
// import aboutImage from '../assets/guidelines'; // Make sure the image path is correct
import guidelines from "../assets/guidelines.png"

function AboutUs() {
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <img src={guidelines} alt="About Us" className="w-full max-w-2xl rounded-lg shadow-lg" />
